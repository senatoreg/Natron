...
static PyObject *Sbk_Natron_Python_PyViewerFunc_getChannels(PyObject *self)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // getChannels()const
            Natron::DisplayChannelsEnum cppResult = Natron::DisplayChannelsEnum(const_cast<const ::Natron::Python::PyViewer *>(cppSelf)->getChannels());
...
static PyObject *Sbk_Natron_Python_PyViewerFunc_getCompositingOperator(PyObject *self)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            Natron::ViewerCompositingOperatorEnum cppResult = Natron::ViewerCompositingOperatorEnum(const_cast<const ::Natron::Python::PyViewer *>(cppSelf)->getCompositingOperator());
...
static PyObject *Sbk_Natron_Python_PyViewerFunc_getPlaybackMode(PyObject *self)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            Natron::PlaybackModeEnum cppResult = Natron::PlaybackModeEnum(const_cast<const ::Natron::Python::PyViewer *>(cppSelf)->getPlaybackMode());
...
static PyObject *Sbk_Natron_Python_PyViewerFunc_setChannels(PyObject *self, PyObject *pyArg)
{
    ...
    // Call function/method
    {
        ::Natron::DisplayChannelsEnum cppArg0{Natron::eDisplayChannelsRGB};
        pythonToCpp(pyArg, &cppArg0);
...
static PyObject *Sbk_Natron_Python_PyViewerFunc_setCompositingOperator(PyObject *self, PyObject *pyArg)
{
    ...
    // Call function/method
    {
        ::Natron::ViewerCompositingOperatorEnum cppArg0{Natron::eViewerCompositingOperatorNone};
        pythonToCpp(pyArg, &cppArg0);
...
static PyObject *Sbk_Natron_Python_PyViewerFunc_setPlaybackMode(PyObject *self, PyObject *pyArg)
{
    ...
    // Call function/method
    {
        ::Natron::PlaybackModeEnum cppArg0{Natron::ePlaybackModeLoop};
        pythonToCpp(pyArg, &cppArg0);
...
static const char *Sbk_Natron_Python_PyViewer_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_PyViewer_SignatureStrings[] = {
    ...
    "NatronGui.PyViewer.getChannels(self)->NatronEngine.Natron.DisplayChannelsEnum",
    "NatronGui.PyViewer.getCompositingOperator(self)->NatronEngine.Natron.ViewerCompositingOperatorEnum",
    ...
    "NatronGui.PyViewer.getPlaybackMode(self)->NatronEngine.Natron.PlaybackModeEnum",
    ...
    "NatronGui.PyViewer.setChannels(self,channels:NatronEngine.Natron.DisplayChannelsEnum)",
    "NatronGui.PyViewer.setCompositingOperator(self,op:NatronEngine.Natron.ViewerCompositingOperatorEnum)",
    "NatronGui.PyViewer.setCurrentView(self,index:int)",
    "NatronGui.PyViewer.setFrameRange(self,firstFrame:int,lastFrame:int)",
    "NatronGui.PyViewer.setPlaybackMode(self,mode:NatronEngine.Natron.PlaybackModeEnum)",
...
void init_Natron_Python_PyViewer(PyObject *module)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_PyViewer_Type);
    InitSignatureStrings(pyType, Natron_Python_PyViewer_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_PyViewer_Type), Sbk_Natron_Python_PyViewer_PropertyStrings);
