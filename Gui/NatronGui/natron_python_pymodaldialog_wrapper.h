...
public:
    ...
    inline void actionEvent_protected(QActionEvent * event) { Natron::Python::PyModalDialog::actionEvent(event); }
    void actionEvent(QActionEvent * event) override;
    inline void adjustPosition_protected(QWidget * arg__1) { Natron::Python::PyModalDialog::adjustPosition(arg__1); }
    inline void changeEvent_protected(QEvent * event) { Natron::Python::PyModalDialog::changeEvent(event); }
    void changeEvent(QEvent * event) override;
    inline void childEvent_protected(QChildEvent * event) { Natron::Python::PyModalDialog::childEvent(event); }
    void childEvent(QChildEvent * event) override;
    inline void closeEvent_protected(QCloseEvent * arg__1) { Natron::Python::PyModalDialog::closeEvent(arg__1); }
    void closeEvent(QCloseEvent * arg__1) override;
    inline void connectNotify_protected(const QMetaMethod & signal) { Natron::Python::PyModalDialog::connectNotify(signal); }
    void connectNotify(const QMetaMethod & signal) override;
    inline void contextMenuEvent_protected(QContextMenuEvent * arg__1) { Natron::Python::PyModalDialog::contextMenuEvent(arg__1); }
    void contextMenuEvent(QContextMenuEvent * arg__1) override;
    inline void customEvent_protected(QEvent * event) { Natron::Python::PyModalDialog::customEvent(event); }
    void customEvent(QEvent * event) override;
    int devType() const override;
    inline void disconnectNotify_protected(const QMetaMethod & signal) { Natron::Python::PyModalDialog::disconnectNotify(signal); }
    void disconnectNotify(const QMetaMethod & signal) override;
    void done(int arg__1) override;
    inline void dragEnterEvent_protected(QDragEnterEvent * event) { Natron::Python::PyModalDialog::dragEnterEvent(event); }
    void dragEnterEvent(QDragEnterEvent * event) override;
    inline void dragLeaveEvent_protected(QDragLeaveEvent * event) { Natron::Python::PyModalDialog::dragLeaveEvent(event); }
    void dragLeaveEvent(QDragLeaveEvent * event) override;
    inline void dragMoveEvent_protected(QDragMoveEvent * event) { Natron::Python::PyModalDialog::dragMoveEvent(event); }
    void dragMoveEvent(QDragMoveEvent * event) override;
    inline void dropEvent_protected(QDropEvent * event) { Natron::Python::PyModalDialog::dropEvent(event); }
    void dropEvent(QDropEvent * event) override;
    inline void enterEvent_protected(QEvent * event) { Natron::Python::PyModalDialog::enterEvent(event); }
    void enterEvent(QEvent * event) override;
    inline bool event_protected(QEvent * event) { return Natron::Python::PyModalDialog::event(event); }
    bool event(QEvent * event) override;
    inline bool eventFilter_protected(QObject * arg__1, QEvent * arg__2) { return Natron::Python::PyModalDialog::eventFilter(arg__1, arg__2); }
    bool eventFilter(QObject * arg__1, QEvent * arg__2) override;
    int exec() override;
    inline void focusInEvent_protected(QFocusEvent * event) { Natron::Python::PyModalDialog::focusInEvent(event); }
    void focusInEvent(QFocusEvent * event) override;
    inline bool focusNextPrevChild_protected(bool next) { return Natron::Python::PyModalDialog::focusNextPrevChild(next); }
    bool focusNextPrevChild(bool next) override;
    inline void focusOutEvent_protected(QFocusEvent * event) { Natron::Python::PyModalDialog::focusOutEvent(event); }
    void focusOutEvent(QFocusEvent * event) override;
    bool hasHeightForWidth() const override;
    int heightForWidth(int arg__1) const override;
    inline void hideEvent_protected(QHideEvent * event) { Natron::Python::PyModalDialog::hideEvent(event); }
    void hideEvent(QHideEvent * event) override;
    inline void initPainter_protected(QPainter * painter) const { Natron::Python::PyModalDialog::initPainter(painter); }
    void initPainter(QPainter * painter) const override;
    inline void inputMethodEvent_protected(QInputMethodEvent * event) { Natron::Python::PyModalDialog::inputMethodEvent(event); }
    void inputMethodEvent(QInputMethodEvent * event) override;
    QVariant inputMethodQuery(Qt::InputMethodQuery arg__1) const override;
    inline void keyPressEvent_protected(QKeyEvent * arg__1) { Natron::Python::PyModalDialog::keyPressEvent(arg__1); }
    void keyPressEvent(QKeyEvent * arg__1) override;
    inline void keyReleaseEvent_protected(QKeyEvent * event) { Natron::Python::PyModalDialog::keyReleaseEvent(event); }
    void keyReleaseEvent(QKeyEvent * event) override;
    inline void leaveEvent_protected(QEvent * event) { Natron::Python::PyModalDialog::leaveEvent(event); }
    void leaveEvent(QEvent * event) override;
    const QMetaObject * metaObject() const override;
    inline int metric_protected(QPaintDevice::PaintDeviceMetric arg__1) const { return Natron::Python::PyModalDialog::metric(QPaintDevice::PaintDeviceMetric(arg__1)); }
    int metric(QPaintDevice::PaintDeviceMetric arg__1) const override;
    QSize minimumSizeHint() const override;
    inline void mouseDoubleClickEvent_protected(QMouseEvent * event) { Natron::Python::PyModalDialog::mouseDoubleClickEvent(event); }
    void mouseDoubleClickEvent(QMouseEvent * event) override;
    inline void mouseMoveEvent_protected(QMouseEvent * event) { Natron::Python::PyModalDialog::mouseMoveEvent(event); }
    void mouseMoveEvent(QMouseEvent * event) override;
    inline void mousePressEvent_protected(QMouseEvent * event) { Natron::Python::PyModalDialog::mousePressEvent(event); }
    void mousePressEvent(QMouseEvent * event) override;
    inline void mouseReleaseEvent_protected(QMouseEvent * event) { Natron::Python::PyModalDialog::mouseReleaseEvent(event); }
    void mouseReleaseEvent(QMouseEvent * event) override;
    inline void moveEvent_protected(QMoveEvent * event) { Natron::Python::PyModalDialog::moveEvent(event); }
    void moveEvent(QMoveEvent * event) override;
    inline bool nativeEvent_protected(const QByteArray & eventType, void * message, long * result) { return Natron::Python::PyModalDialog::nativeEvent(eventType, message, result); }
    bool nativeEvent(const QByteArray & eventType, void * message, long * result) override;
    void open() override;
    QPaintEngine * paintEngine() const override;
    inline void paintEvent_protected(QPaintEvent * event) { Natron::Python::PyModalDialog::paintEvent(event); }
    void paintEvent(QPaintEvent * event) override;
    inline QPaintDevice * redirected_protected(QPoint * offset) const { return Natron::Python::PyModalDialog::redirected(offset); }
    QPaintDevice * redirected(QPoint * offset) const override;
    void reject() override;
    inline void resizeEvent_protected(QResizeEvent * arg__1) { Natron::Python::PyModalDialog::resizeEvent(arg__1); }
    void resizeEvent(QResizeEvent * arg__1) override;
    void setVisible(bool visible) override;
    inline QPainter * sharedPainter_protected() const { return Natron::Python::PyModalDialog::sharedPainter(); }
    QPainter * sharedPainter() const override;
    inline void showEvent_protected(QShowEvent * arg__1) { Natron::Python::PyModalDialog::showEvent(arg__1); }
    void showEvent(QShowEvent * arg__1) override;
    QSize sizeHint() const override;
    inline void tabletEvent_protected(QTabletEvent * event) { Natron::Python::PyModalDialog::tabletEvent(event); }
    void tabletEvent(QTabletEvent * event) override;
    inline void timerEvent_protected(QTimerEvent * event) { Natron::Python::PyModalDialog::timerEvent(event); }
    void timerEvent(QTimerEvent * event) override;
    inline void wheelEvent_protected(QWheelEvent * event) { Natron::Python::PyModalDialog::wheelEvent(event); }
