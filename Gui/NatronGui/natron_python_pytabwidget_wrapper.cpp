...
static const char *Sbk_Natron_Python_PyTabWidget_PropertyStrings[] = {
    nullptr // Sentinel
};
...
void init_Natron_Python_PyTabWidget(PyObject *module)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_PyTabWidget_Type);
    InitSignatureStrings(pyType, Natron_Python_PyTabWidget_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_PyTabWidget_Type), Sbk_Natron_Python_PyTabWidget_PropertyStrings);
