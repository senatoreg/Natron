...
static const char *Sbk_Natron_Python_ChoiceParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_ChoiceParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.ChoiceParam.addAsDependencyOf(self,fromExprDimension:int,param:NatronEngine.Natron.Python.Param,thisDimension:int)->int",
    "NatronEngine.Natron.Python.ChoiceParam.addOption(self,option:QString,help:QString)",
    "1:NatronEngine.Natron.Python.ChoiceParam.get(self)->int",
    "0:NatronEngine.Natron.Python.ChoiceParam.get(self,frame:double)->int",
    "NatronEngine.Natron.Python.ChoiceParam.getDefaultValue(self)->int",
    "NatronEngine.Natron.Python.ChoiceParam.getNumOptions(self)->int",
    "NatronEngine.Natron.Python.ChoiceParam.getOption(self,index:int)->QString",
    "NatronEngine.Natron.Python.ChoiceParam.getOptions(self)->QStringList",
    "NatronEngine.Natron.Python.ChoiceParam.getValue(self)->int",
    "NatronEngine.Natron.Python.ChoiceParam.getValueAtTime(self,time:double)->int",
    "NatronEngine.Natron.Python.ChoiceParam.restoreDefaultValue(self)",
    "2:NatronEngine.Natron.Python.ChoiceParam.set(self,label:QString)",
    "1:NatronEngine.Natron.Python.ChoiceParam.set(self,x:int)",
    "0:NatronEngine.Natron.Python.ChoiceParam.set(self,x:int,frame:double)",
    "1:NatronEngine.Natron.Python.ChoiceParam.setDefaultValue(self,value:QString)",
    "0:NatronEngine.Natron.Python.ChoiceParam.setDefaultValue(self,value:int)",
    "NatronEngine.Natron.Python.ChoiceParam.setOptions(self,options:std.list[std.pair[QString, QString]])",
    "1:NatronEngine.Natron.Python.ChoiceParam.setValue(self,label:QString)",
    "0:NatronEngine.Natron.Python.ChoiceParam.setValue(self,value:int)",
    "NatronEngine.Natron.Python.ChoiceParam.setValueAtTime(self,value:int,time:double)",
    nullptr}; // Sentinel
...
void init_Natron_Python_ChoiceParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_ChoiceParam_Type);
    InitSignatureStrings(pyType, Natron_Python_ChoiceParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_ChoiceParam_Type), Sbk_Natron_Python_ChoiceParam_PropertyStrings);
