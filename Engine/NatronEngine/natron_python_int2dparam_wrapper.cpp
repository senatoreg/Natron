...
static const char *Sbk_Natron_Python_Int2DParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_Int2DParam_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.Int2DParam.get(self)->NatronEngine.Natron.Python.Int2DTuple",
    "0:NatronEngine.Natron.Python.Int2DParam.get(self,frame:double)->NatronEngine.Natron.Python.Int2DTuple",
    "2:NatronEngine.Natron.Python.Int2DParam.set(self,x:int,y:int)",
    "1:NatronEngine.Natron.Python.Int2DParam.set(self,x:int)",
    "0:NatronEngine.Natron.Python.Int2DParam.set(self,x:int,y:int,frame:double)",
    nullptr}; // Sentinel
...
void init_Natron_Python_Int2DParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Int2DParam_Type);
    InitSignatureStrings(pyType, Natron_Python_Int2DParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Int2DParam_Type), Sbk_Natron_Python_Int2DParam_PropertyStrings);
