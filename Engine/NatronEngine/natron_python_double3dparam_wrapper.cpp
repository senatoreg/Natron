...
static const char *Sbk_Natron_Python_Double3DParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_Double3DParam_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.Double3DParam.get(self)->NatronEngine.Natron.Python.Double3DTuple",
    "0:NatronEngine.Natron.Python.Double3DParam.get(self,frame:double)->NatronEngine.Natron.Python.Double3DTuple",
    "3:NatronEngine.Natron.Python.Double3DParam.set(self,x:double,y:double,z:double)",
    "2:NatronEngine.Natron.Python.Double3DParam.set(self,x:double,y:double)",
    "1:NatronEngine.Natron.Python.Double3DParam.set(self,x:double)",
    "0:NatronEngine.Natron.Python.Double3DParam.set(self,x:double,y:double,z:double,frame:double)",
    nullptr}; // Sentinel
...
void init_Natron_Python_Double3DParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Double3DParam_Type);
    InitSignatureStrings(pyType, Natron_Python_Double3DParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Double3DParam_Type), Sbk_Natron_Python_Double3DParam_PropertyStrings);
