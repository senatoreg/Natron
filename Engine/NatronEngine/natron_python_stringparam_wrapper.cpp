...
static const char *Sbk_Natron_Python_StringParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_StringParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.StringParam.setType(self,type:NatronEngine.Natron.Python.StringParam.TypeEnum)",
    nullptr}; // Sentinel
...
void init_Natron_Python_StringParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_StringParam_Type);
    InitSignatureStrings(pyType, Natron_Python_StringParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_StringParam_Type), Sbk_Natron_Python_StringParam_PropertyStrings);
