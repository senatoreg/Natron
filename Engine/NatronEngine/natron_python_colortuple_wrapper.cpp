...
static const char *Sbk_Natron_Python_ColorTuple_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_ColorTuple_SignatureStrings[] = {
    "NatronEngine.Natron.Python.ColorTuple(self)",
    nullptr}; // Sentinel
...
void init_Natron_Python_ColorTuple(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_ColorTuple_Type);
    InitSignatureStrings(pyType, Natron_Python_ColorTuple_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_ColorTuple_Type), Sbk_Natron_Python_ColorTuple_PropertyStrings);
