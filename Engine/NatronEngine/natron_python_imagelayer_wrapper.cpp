...
static const char *Sbk_Natron_Python_ImageLayer_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_ImageLayer_SignatureStrings[] = {
    "NatronEngine.Natron.Python.ImageLayer(self,layerName:QString,componentsPrettyName:QString,componentsName:QStringList)",
    ...
    "NatronEngine.Natron.Python.ImageLayer.getComponentsNames(self)->QStringList",
    "NatronEngine.Natron.Python.ImageLayer.getComponentsPrettyName(self)->QString",
    ...
    "NatronEngine.Natron.Python.ImageLayer.getLayerName(self)->QString",
    "NatronEngine.Natron.Python.ImageLayer.getNoneComponents()->NatronEngine.Natron.Python.ImageLayer",
    "NatronEngine.Natron.Python.ImageLayer.getNumComponents(self)->int",
    ...
    "NatronEngine.Natron.Python.ImageLayer.isColorPlane(self)->bool",
...
void init_Natron_Python_ImageLayer(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_ImageLayer_Type);
    InitSignatureStrings(pyType, Natron_Python_ImageLayer_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_ImageLayer_Type), Sbk_Natron_Python_ImageLayer_PropertyStrings);
