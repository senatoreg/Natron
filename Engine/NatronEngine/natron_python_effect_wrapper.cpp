...
static const char *Sbk_Natron_Python_Effect_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_Effect_SignatureStrings[] = {
    "NatronEngine.Natron.Python.Effect.addUserPlane(self,planeName:QString,channels:QStringList)->bool",
    "NatronEngine.Natron.Python.Effect.beginChanges(self)",
    "NatronEngine.Natron.Python.Effect.canConnectInput(self,inputNumber:int,node:NatronEngine.Natron.Python.Effect)->bool",
    "NatronEngine.Natron.Python.Effect.connectInput(self,inputNumber:int,input:NatronEngine.Natron.Python.Effect)->bool",
    "NatronEngine.Natron.Python.Effect.destroy(self,autoReconnect:bool=true)",
    "NatronEngine.Natron.Python.Effect.disconnectInput(self,inputNumber:int)",
    "NatronEngine.Natron.Python.Effect.endChanges(self)",
    "NatronEngine.Natron.Python.Effect.getAvailableLayers(self,inputNb:int)->std.list[NatronEngine.Natron.Python.ImageLayer]",
    "NatronEngine.Natron.Python.Effect.getBitDepth(self)->NatronEngine.Natron.ImageBitDepthEnum",
    "NatronEngine.Natron.Python.Effect.getColor(self,r:double*,g:double*,b:double*)",
    "NatronEngine.Natron.Python.Effect.getCurrentTime(self)->int",
    "NatronEngine.Natron.Python.Effect.getFrameRate(self)->double",
    "1:NatronEngine.Natron.Python.Effect.getInput(self,inputLabel:QString)->NatronEngine.Natron.Python.Effect",
    "0:NatronEngine.Natron.Python.Effect.getInput(self,inputNumber:int)->NatronEngine.Natron.Python.Effect",
    "NatronEngine.Natron.Python.Effect.getInputLabel(self,inputNumber:int)->QString",
    "NatronEngine.Natron.Python.Effect.getLabel(self)->QString",
    "NatronEngine.Natron.Python.Effect.getMaxInputCount(self)->int",
    "NatronEngine.Natron.Python.Effect.getOutputFormat(self)->NatronEngine.Natron.RectI",
    "NatronEngine.Natron.Python.Effect.getParam(self,name:QString)->NatronEngine.Natron.Python.Param",
    "NatronEngine.Natron.Python.Effect.getParams(self)->std.list[NatronEngine.Natron.Python.Param]",
    "NatronEngine.Natron.Python.Effect.getPixelAspectRatio(self)->double",
    "NatronEngine.Natron.Python.Effect.getPluginID(self)->QString",
    "NatronEngine.Natron.Python.Effect.getPosition(self,x:double*,y:double*)",
    "NatronEngine.Natron.Python.Effect.getPremult(self)->NatronEngine.Natron.ImagePremultiplicationEnum",
    "NatronEngine.Natron.Python.Effect.getRegionOfDefinition(self,time:double,view:int)->NatronEngine.Natron.RectD",
    "NatronEngine.Natron.Python.Effect.getRotoContext(self)->NatronEngine.Natron.Python.Roto",
    "NatronEngine.Natron.Python.Effect.getScriptName(self)->QString",
    "NatronEngine.Natron.Python.Effect.getSize(self,w:double*,h:double*)",
    "NatronEngine.Natron.Python.Effect.getTrackerContext(self)->NatronEngine.Natron.Python.Tracker",
    "NatronEngine.Natron.Python.Effect.getUserPageParam(self)->NatronEngine.Natron.Python.PageParam",
    "NatronEngine.Natron.Python.Effect.isNodeSelected(self)->bool",
    "NatronEngine.Natron.Python.Effect.isOutputNode(self)->bool",
    "NatronEngine.Natron.Python.Effect.isReaderNode(self)->bool",
    "NatronEngine.Natron.Python.Effect.isWriterNode(self)->bool",
    "NatronEngine.Natron.Python.Effect.setColor(self,r:double,g:double,b:double)",
    "NatronEngine.Natron.Python.Effect.setLabel(self,name:QString)",
    "NatronEngine.Natron.Python.Effect.setPagesOrder(self,pages:QStringList)",
    "NatronEngine.Natron.Python.Effect.setPosition(self,x:double,y:double)",
    "NatronEngine.Natron.Python.Effect.setScriptName(self,scriptName:QString)->bool",
    "NatronEngine.Natron.Python.Effect.setSize(self,w:double,h:double)",
    "NatronEngine.Natron.Python.Effect.setSubGraphEditable(self,editable:bool)",
    nullptr}; // Sentinel
...
void init_Natron_Python_Effect(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Effect_Type);
    InitSignatureStrings(pyType, Natron_Python_Effect_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Effect_Type), Sbk_Natron_Python_Effect_PropertyStrings);
