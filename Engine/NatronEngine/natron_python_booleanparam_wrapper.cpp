...
static const char *Sbk_Natron_Python_BooleanParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_BooleanParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.BooleanParam.addAsDependencyOf(self,fromExprDimension:int,param:NatronEngine.Natron.Python.Param,thisDimension:int)->bool",
    "1:NatronEngine.Natron.Python.BooleanParam.get(self)->bool",
    "0:NatronEngine.Natron.Python.BooleanParam.get(self,frame:double)->bool",
    "NatronEngine.Natron.Python.BooleanParam.getDefaultValue(self)->bool",
    "NatronEngine.Natron.Python.BooleanParam.getValue(self)->bool",
    "NatronEngine.Natron.Python.BooleanParam.getValueAtTime(self,time:double)->bool",
    "NatronEngine.Natron.Python.BooleanParam.restoreDefaultValue(self)",
    "1:NatronEngine.Natron.Python.BooleanParam.set(self,x:bool)",
    "0:NatronEngine.Natron.Python.BooleanParam.set(self,x:bool,frame:double)",
    "NatronEngine.Natron.Python.BooleanParam.setDefaultValue(self,value:bool)",
    "NatronEngine.Natron.Python.BooleanParam.setValue(self,value:bool)",
    "NatronEngine.Natron.Python.BooleanParam.setValueAtTime(self,value:bool,time:double)",
    nullptr}; // Sentinel
...
void init_Natron_Python_BooleanParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_BooleanParam_Type);
    InitSignatureStrings(pyType, Natron_Python_BooleanParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_BooleanParam_Type), Sbk_Natron_Python_BooleanParam_PropertyStrings);
