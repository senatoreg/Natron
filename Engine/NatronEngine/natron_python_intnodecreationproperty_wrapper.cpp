...
static const char *Sbk_Natron_Python_IntNodeCreationProperty_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_IntNodeCreationProperty_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.IntNodeCreationProperty(self,values:std.vector[int]=std.vector< int >())",
    "0:NatronEngine.Natron.Python.IntNodeCreationProperty(self,value:int)",
    "NatronEngine.Natron.Python.IntNodeCreationProperty.getValues(self)->std.vector[int]",
    "NatronEngine.Natron.Python.IntNodeCreationProperty.setValue(self,value:int,index:int=0)",
    nullptr}; // Sentinel
...
void init_Natron_Python_IntNodeCreationProperty(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_IntNodeCreationProperty_Type);
    InitSignatureStrings(pyType, Natron_Python_IntNodeCreationProperty_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_IntNodeCreationProperty_Type), Sbk_Natron_Python_IntNodeCreationProperty_PropertyStrings);
