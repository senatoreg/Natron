...
static const char *Sbk_Natron_Python_Int2DTuple_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_Int2DTuple_SignatureStrings[] = {
    "NatronEngine.Natron.Python.Int2DTuple(self)",
    nullptr}; // Sentinel
...
void init_Natron_Python_Int2DTuple(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Int2DTuple_Type);
    InitSignatureStrings(pyType, Natron_Python_Int2DTuple_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Int2DTuple_Type), Sbk_Natron_Python_Int2DTuple_PropertyStrings);
