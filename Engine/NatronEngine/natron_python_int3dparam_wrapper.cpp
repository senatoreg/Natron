...
static const char *Sbk_Natron_Python_Int3DParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_Int3DParam_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.Int3DParam.get(self)->NatronEngine.Natron.Python.Int3DTuple",
    "0:NatronEngine.Natron.Python.Int3DParam.get(self,frame:double)->NatronEngine.Natron.Python.Int3DTuple",
    "3:NatronEngine.Natron.Python.Int3DParam.set(self,x:int,y:int,z:int)",
    "2:NatronEngine.Natron.Python.Int3DParam.set(self,x:int,y:int)",
    "1:NatronEngine.Natron.Python.Int3DParam.set(self,x:int)",
    "0:NatronEngine.Natron.Python.Int3DParam.set(self,x:int,y:int,z:int,frame:double)",
    nullptr}; // Sentinel
...
void init_Natron_Python_Int3DParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Int3DParam_Type);
    InitSignatureStrings(pyType, Natron_Python_Int3DParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Int3DParam_Type), Sbk_Natron_Python_Int3DParam_PropertyStrings);
