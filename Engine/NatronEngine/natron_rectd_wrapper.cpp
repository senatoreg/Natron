...
static const char *Sbk_Natron_RectD_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_RectD_SignatureStrings[] = {
    "2:NatronEngine.Natron.RectD(self)",
    "1:NatronEngine.Natron.RectD(self,b:NatronEngine.Natron.RectD)",
    "0:NatronEngine.Natron.RectD(self,l:double,b:double,r:double,t:double)",
    "NatronEngine.Natron.RectD.area(self)->double",
    "NatronEngine.Natron.RectD.bottom(self)->double",
    "NatronEngine.Natron.RectD.clear(self)",
    "1:NatronEngine.Natron.RectD.contains(self,other:NatronEngine.Natron.RectD)->bool",
    "0:NatronEngine.Natron.RectD.contains(self,x:double,y:double)->bool",
    "NatronEngine.Natron.RectD.height(self)->double",
    "1:NatronEngine.Natron.RectD.intersect(self,r:NatronEngine.Natron.RectD,intersection:NatronEngine.Natron.RectD)->bool",
    "0:NatronEngine.Natron.RectD.intersect(self,l:double,b:double,r:double,t:double,intersection:NatronEngine.Natron.RectD)->bool",
    "1:NatronEngine.Natron.RectD.intersects(self,r:NatronEngine.Natron.RectD)->bool",
    "0:NatronEngine.Natron.RectD.intersects(self,l:double,b:double,r:double,t:double)->bool",
    "NatronEngine.Natron.RectD.isInfinite(self)->bool",
    "NatronEngine.Natron.RectD.isNull(self)->bool",
    "NatronEngine.Natron.RectD.left(self)->double",
    "1:NatronEngine.Natron.RectD.merge(self,box:NatronEngine.Natron.RectD)",
    "0:NatronEngine.Natron.RectD.merge(self,l:double,b:double,r:double,t:double)",
    "NatronEngine.Natron.RectD.right(self)->double",
    "1:NatronEngine.Natron.RectD.set(self,b:NatronEngine.Natron.RectD)",
    "0:NatronEngine.Natron.RectD.set(self,l:double,b:double,r:double,t:double)",
    "NatronEngine.Natron.RectD.set_bottom(self,v:double)",
    "NatronEngine.Natron.RectD.set_left(self,v:double)",
    "NatronEngine.Natron.RectD.set_right(self,v:double)",
    "NatronEngine.Natron.RectD.set_top(self,v:double)",
    "NatronEngine.Natron.RectD.setupInfinity(self)",
    "NatronEngine.Natron.RectD.top(self)->double",
    "NatronEngine.Natron.RectD.translate(self,dx:int,dy:int)",
    "NatronEngine.Natron.RectD.width(self)->double",
    nullptr}; // Sentinel
...
void init_Natron_RectD(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_RectD_Type);
    InitSignatureStrings(pyType, Natron_RectD_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_RectD_Type), Sbk_Natron_RectD_PropertyStrings);
