...
static const char *Sbk_Natron_RectI_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_RectI_SignatureStrings[] = {
    "2:NatronEngine.Natron.RectI(self)",
    "1:NatronEngine.Natron.RectI(self,b:NatronEngine.Natron.RectI)",
    "0:NatronEngine.Natron.RectI(self,x1_:int,y1_:int,x2_:int,y2_:int)",
    "NatronEngine.Natron.RectI.bottom(self)->int",
    "NatronEngine.Natron.RectI.clear(self)",
    "2:NatronEngine.Natron.RectI.contains(self,other:NatronEngine.Natron.RectI)->bool",
    "1:NatronEngine.Natron.RectI.contains(self,x:double,y:double)->bool",
    "0:NatronEngine.Natron.RectI.contains(self,x:int,y:int)->bool",
    "NatronEngine.Natron.RectI.height(self)->int",
    "1:NatronEngine.Natron.RectI.intersect(self,r:NatronEngine.Natron.RectI,intersection:NatronEngine.Natron.RectI)->bool",
    "0:NatronEngine.Natron.RectI.intersect(self,x1_:int,y1_:int,x2_:int,y2_:int,intersection:NatronEngine.Natron.RectI)->bool",
    "1:NatronEngine.Natron.RectI.intersects(self,r:NatronEngine.Natron.RectI)->bool",
    "0:NatronEngine.Natron.RectI.intersects(self,x1_:int,y1_:int,x2_:int,y2_:int)->bool",
    "NatronEngine.Natron.RectI.isInfinite(self)->bool",
    "NatronEngine.Natron.RectI.isNull(self)->bool",
    "NatronEngine.Natron.RectI.left(self)->int",
    "1:NatronEngine.Natron.RectI.merge(self,box:NatronEngine.Natron.RectI)",
    "0:NatronEngine.Natron.RectI.merge(self,x1_:int,y1_:int,x2_:int,y2_:int)",
    "NatronEngine.Natron.RectI.right(self)->int",
    "1:NatronEngine.Natron.RectI.set(self,b:NatronEngine.Natron.RectI)",
    "0:NatronEngine.Natron.RectI.set(self,x1_:int,y1_:int,x2_:int,y2_:int)",
    "NatronEngine.Natron.RectI.set_bottom(self,v:int)",
    "NatronEngine.Natron.RectI.set_left(self,v:int)",
    "NatronEngine.Natron.RectI.set_right(self,v:int)",
    "NatronEngine.Natron.RectI.set_top(self,v:int)",
    "NatronEngine.Natron.RectI.top(self)->int",
    "NatronEngine.Natron.RectI.translate(self,dx:int,dy:int)",
    "NatronEngine.Natron.RectI.width(self)->int",
    nullptr}; // Sentinel
...
void init_Natron_RectI(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_RectI_Type);
    InitSignatureStrings(pyType, Natron_RectI_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_RectI_Type), Sbk_Natron_RectI_PropertyStrings);
