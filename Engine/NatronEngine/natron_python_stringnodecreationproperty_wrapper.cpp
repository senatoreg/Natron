...
static const char *Sbk_Natron_Python_StringNodeCreationProperty_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_StringNodeCreationProperty_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.StringNodeCreationProperty(self,value:std.string)",
    "0:NatronEngine.Natron.Python.StringNodeCreationProperty(self,values:std.vector[std.string]=std.vector< std.string >())",
    "NatronEngine.Natron.Python.StringNodeCreationProperty.getValues(self)->std.vector[std.string]",
    "NatronEngine.Natron.Python.StringNodeCreationProperty.setValue(self,value:std.string,index:int=0)",
    nullptr}; // Sentinel
...
void init_Natron_Python_StringNodeCreationProperty(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_StringNodeCreationProperty_Type);
    InitSignatureStrings(pyType, Natron_Python_StringNodeCreationProperty_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_StringNodeCreationProperty_Type), Sbk_Natron_Python_StringNodeCreationProperty_PropertyStrings);
