...
static const char *Sbk_Natron_Python_Double3DTuple_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_Double3DTuple_SignatureStrings[] = {
    "NatronEngine.Natron.Python.Double3DTuple(self)",
    nullptr}; // Sentinel
...
void init_Natron_Python_Double3DTuple(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Double3DTuple_Type);
    InitSignatureStrings(pyType, Natron_Python_Double3DTuple_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Double3DTuple_Type), Sbk_Natron_Python_Double3DTuple_PropertyStrings);
