...
static const char *Sbk_Natron_Python_DoubleParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_DoubleParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.DoubleParam.addAsDependencyOf(self,fromExprDimension:int,param:NatronEngine.Natron.Python.Param,thisDimension:int)->double",
    "1:NatronEngine.Natron.Python.DoubleParam.get(self)->double",
    "0:NatronEngine.Natron.Python.DoubleParam.get(self,frame:double)->double",
    "NatronEngine.Natron.Python.DoubleParam.getDefaultValue(self,dimension:int=0)->double",
    "NatronEngine.Natron.Python.DoubleParam.getDisplayMaximum(self,dimension:int)->double",
    "NatronEngine.Natron.Python.DoubleParam.getDisplayMinimum(self,dimension:int)->double",
    "NatronEngine.Natron.Python.DoubleParam.getMaximum(self,dimension:int=0)->double",
    "NatronEngine.Natron.Python.DoubleParam.getMinimum(self,dimension:int=0)->double",
    "NatronEngine.Natron.Python.DoubleParam.getValue(self,dimension:int=0)->double",
    "NatronEngine.Natron.Python.DoubleParam.getValueAtTime(self,time:double,dimension:int=0)->double",
    "NatronEngine.Natron.Python.DoubleParam.restoreDefaultValue(self,dimension:int=0)",
    "1:NatronEngine.Natron.Python.DoubleParam.set(self,x:double)",
    "0:NatronEngine.Natron.Python.DoubleParam.set(self,x:double,frame:double)",
    "NatronEngine.Natron.Python.DoubleParam.setDefaultValue(self,value:double,dimension:int=0)",
    "NatronEngine.Natron.Python.DoubleParam.setDisplayMaximum(self,maximum:double,dimension:int=0)",
    "NatronEngine.Natron.Python.DoubleParam.setDisplayMinimum(self,minimum:double,dimension:int=0)",
    "NatronEngine.Natron.Python.DoubleParam.setMaximum(self,maximum:double,dimension:int=0)",
    "NatronEngine.Natron.Python.DoubleParam.setMinimum(self,minimum:double,dimension:int=0)",
    "NatronEngine.Natron.Python.DoubleParam.setValue(self,value:double,dimension:int=0)",
    "NatronEngine.Natron.Python.DoubleParam.setValueAtTime(self,value:double,time:double,dimension:int=0)",
    nullptr}; // Sentinel
...
void init_Natron_Python_DoubleParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_DoubleParam_Type);
    InitSignatureStrings(pyType, Natron_Python_DoubleParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_DoubleParam_Type), Sbk_Natron_Python_DoubleParam_PropertyStrings);
