...
static const char *Sbk_Natron_Python_AppSettings_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_AppSettings_SignatureStrings[] = {
    "NatronEngine.Natron.Python.AppSettings.getParam(self,scriptName:QString)->NatronEngine.Natron.Python.Param",
    "NatronEngine.Natron.Python.AppSettings.getParams(self)->std.list[NatronEngine.Natron.Python.Param]",
    "NatronEngine.Natron.Python.AppSettings.restoreDefaultSettings(self)",
    "NatronEngine.Natron.Python.AppSettings.saveSettings(self)",
    nullptr}; // Sentinel
...
void init_Natron_Python_AppSettings(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_AppSettings_Type);
    InitSignatureStrings(pyType, Natron_Python_AppSettings_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_AppSettings_Type), Sbk_Natron_Python_AppSettings_PropertyStrings);
