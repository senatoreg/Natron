...
static const char *Sbk_Natron_Python_PathParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_PathParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.PathParam.getTable(self,table:std.list[std.vector[std.string]])",
    "NatronEngine.Natron.Python.PathParam.setAsMultiPathTable(self)",
    "NatronEngine.Natron.Python.PathParam.setTable(self,table:std.list[std.vector[std.string]])",
    nullptr}; // Sentinel
...
void init_Natron_Python_PathParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_PathParam_Type);
    InitSignatureStrings(pyType, Natron_Python_PathParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_PathParam_Type), Sbk_Natron_Python_PathParam_PropertyStrings);
