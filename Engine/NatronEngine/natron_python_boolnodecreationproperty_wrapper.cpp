...
static const char *Sbk_Natron_Python_BoolNodeCreationProperty_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_BoolNodeCreationProperty_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.BoolNodeCreationProperty(self,value:bool)",
    "0:NatronEngine.Natron.Python.BoolNodeCreationProperty(self,values:std.vector[bool]=std.vector< bool >())",
    "NatronEngine.Natron.Python.BoolNodeCreationProperty.getValues(self)->std.vector[bool]",
    "NatronEngine.Natron.Python.BoolNodeCreationProperty.setValue(self,value:bool,index:int=0)",
    nullptr}; // Sentinel
...
void init_Natron_Python_BoolNodeCreationProperty(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_BoolNodeCreationProperty_Type);
    InitSignatureStrings(pyType, Natron_Python_BoolNodeCreationProperty_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_BoolNodeCreationProperty_Type), Sbk_Natron_Python_BoolNodeCreationProperty_PropertyStrings);
