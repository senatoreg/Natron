...
static const char *Sbk_Natron_Python_GroupParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_GroupParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.GroupParam.addParam(self,param:NatronEngine.Natron.Python.Param)",
    "NatronEngine.Natron.Python.GroupParam.getIsOpened(self)->bool",
    "NatronEngine.Natron.Python.GroupParam.setAsTab(self)",
    "NatronEngine.Natron.Python.GroupParam.setOpened(self,opened:bool)",
    nullptr}; // Sentinel
...
void init_Natron_Python_GroupParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_GroupParam_Type);
    InitSignatureStrings(pyType, Natron_Python_GroupParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_GroupParam_Type), Sbk_Natron_Python_GroupParam_PropertyStrings);
