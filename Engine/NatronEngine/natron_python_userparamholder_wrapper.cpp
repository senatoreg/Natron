...
static const char *Sbk_Natron_Python_UserParamHolder_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_UserParamHolder_SignatureStrings[] = {
    "NatronEngine.Natron.Python.UserParamHolder(self)",
    "NatronEngine.Natron.Python.UserParamHolder.createBooleanParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.BooleanParam",
    "NatronEngine.Natron.Python.UserParamHolder.createButtonParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.ButtonParam",
    "NatronEngine.Natron.Python.UserParamHolder.createChoiceParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.ChoiceParam",
    "NatronEngine.Natron.Python.UserParamHolder.createColorParam(self,name:QString,label:QString,useAlpha:bool)->NatronEngine.Natron.Python.ColorParam",
    "NatronEngine.Natron.Python.UserParamHolder.createDouble2DParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.Double2DParam",
    "NatronEngine.Natron.Python.UserParamHolder.createDouble3DParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.Double3DParam",
    "NatronEngine.Natron.Python.UserParamHolder.createDoubleParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.DoubleParam",
    "NatronEngine.Natron.Python.UserParamHolder.createFileParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.FileParam",
    "NatronEngine.Natron.Python.UserParamHolder.createGroupParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.GroupParam",
    "NatronEngine.Natron.Python.UserParamHolder.createInt2DParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.Int2DParam",
    "NatronEngine.Natron.Python.UserParamHolder.createInt3DParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.Int3DParam",
    "NatronEngine.Natron.Python.UserParamHolder.createIntParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.IntParam",
    "NatronEngine.Natron.Python.UserParamHolder.createOutputFileParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.OutputFileParam",
    "NatronEngine.Natron.Python.UserParamHolder.createPageParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.PageParam",
    "NatronEngine.Natron.Python.UserParamHolder.createParametricParam(self,name:QString,label:QString,nbCurves:int)->NatronEngine.Natron.Python.ParametricParam",
    "NatronEngine.Natron.Python.UserParamHolder.createPathParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.PathParam",
    "NatronEngine.Natron.Python.UserParamHolder.createSeparatorParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.SeparatorParam",
    "NatronEngine.Natron.Python.UserParamHolder.createStringParam(self,name:QString,label:QString)->NatronEngine.Natron.Python.StringParam",
    "NatronEngine.Natron.Python.UserParamHolder.refreshUserParamsGUI(self)",
    "NatronEngine.Natron.Python.UserParamHolder.removeParam(self,param:NatronEngine.Natron.Python.Param)->bool",
    nullptr}; // Sentinel
...
void init_Natron_Python_UserParamHolder(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_UserParamHolder_Type);
    InitSignatureStrings(pyType, Natron_Python_UserParamHolder_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_UserParamHolder_Type), Sbk_Natron_Python_UserParamHolder_PropertyStrings);
