...
static const char *Sbk_Natron_Python_Tracker_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_Tracker_SignatureStrings[] = {
    "NatronEngine.Natron.Python.Tracker.createTrack(self)->NatronEngine.Natron.Python.Track",
    "NatronEngine.Natron.Python.Tracker.getAllTracks(self,markers:std.list[NatronEngine.Natron.Python.Track])",
    "NatronEngine.Natron.Python.Tracker.getSelectedTracks(self,markers:std.list[NatronEngine.Natron.Python.Track])",
    "NatronEngine.Natron.Python.Tracker.getTrackByName(self,name:QString)->NatronEngine.Natron.Python.Track",
    "NatronEngine.Natron.Python.Tracker.startTracking(self,marks:std.list[NatronEngine.Natron.Python.Track],start:int,end:int,forward:bool)",
    "NatronEngine.Natron.Python.Tracker.stopTracking(self)",
    nullptr}; // Sentinel
...
void init_Natron_Python_Tracker(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Tracker_Type);
    InitSignatureStrings(pyType, Natron_Python_Tracker_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Tracker_Type), Sbk_Natron_Python_Tracker_PropertyStrings);
