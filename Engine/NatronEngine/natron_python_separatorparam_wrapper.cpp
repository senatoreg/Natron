...
static const char *Sbk_Natron_Python_SeparatorParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
void init_Natron_Python_SeparatorParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_SeparatorParam_Type);
    InitSignatureStrings(pyType, Natron_Python_SeparatorParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_SeparatorParam_Type), Sbk_Natron_Python_SeparatorParam_PropertyStrings);
