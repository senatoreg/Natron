...
static const char *Sbk_Natron_Python_NodeCreationProperty_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_NodeCreationProperty_SignatureStrings[] = {
    "NatronEngine.Natron.Python.NodeCreationProperty(self)",
    nullptr}; // Sentinel
...
void init_Natron_Python_NodeCreationProperty(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_NodeCreationProperty_Type);
    InitSignatureStrings(pyType, Natron_Python_NodeCreationProperty_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_NodeCreationProperty_Type), Sbk_Natron_Python_NodeCreationProperty_PropertyStrings);
