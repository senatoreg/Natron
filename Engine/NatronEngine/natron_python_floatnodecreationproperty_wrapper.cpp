...
static const char *Sbk_Natron_Python_FloatNodeCreationProperty_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_FloatNodeCreationProperty_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.FloatNodeCreationProperty(self,values:std.vector[double]=std.vector< double >())",
    "0:NatronEngine.Natron.Python.FloatNodeCreationProperty(self,value:double)",
    "NatronEngine.Natron.Python.FloatNodeCreationProperty.getValues(self)->std.vector[double]",
    "NatronEngine.Natron.Python.FloatNodeCreationProperty.setValue(self,value:double,index:int=0)",
    nullptr}; // Sentinel
...
void init_Natron_Python_FloatNodeCreationProperty(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_FloatNodeCreationProperty_Type);
    InitSignatureStrings(pyType, Natron_Python_FloatNodeCreationProperty_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_FloatNodeCreationProperty_Type), Sbk_Natron_Python_FloatNodeCreationProperty_PropertyStrings);
