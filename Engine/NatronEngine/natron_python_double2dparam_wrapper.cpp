...
static const char *Sbk_Natron_Python_Double2DParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_Double2DParam_SignatureStrings[] = {
    "1:NatronEngine.Natron.Python.Double2DParam.get(self)->NatronEngine.Natron.Python.Double2DTuple",
    "0:NatronEngine.Natron.Python.Double2DParam.get(self,frame:double)->NatronEngine.Natron.Python.Double2DTuple",
    "2:NatronEngine.Natron.Python.Double2DParam.set(self,x:double,y:double)",
    "1:NatronEngine.Natron.Python.Double2DParam.set(self,x:double)",
    "0:NatronEngine.Natron.Python.Double2DParam.set(self,x:double,y:double,frame:double)",
    "NatronEngine.Natron.Python.Double2DParam.setCanAutoFoldDimensions(self,can:bool)",
    "NatronEngine.Natron.Python.Double2DParam.setUsePointInteract(self,use:bool)",
    nullptr}; // Sentinel
...
void init_Natron_Python_Double2DParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Double2DParam_Type);
    InitSignatureStrings(pyType, Natron_Python_Double2DParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Double2DParam_Type), Sbk_Natron_Python_Double2DParam_PropertyStrings);
