...
static const char *Sbk_Natron_Python_App_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_App_SignatureStrings[] = {
    "NatronEngine.Natron.Python.App.addFormat(self,formatSpec:QString)",
    "NatronEngine.Natron.Python.App.addProjectLayer(self,layer:NatronEngine.Natron.Python.ImageLayer)",
    "NatronEngine.Natron.Python.App.closeProject(self)->bool",
    "NatronEngine.Natron.Python.App.createNode(self,pluginID:QString,majorVersion:int=-1,group:NatronEngine.Natron.Python.Group=0,props:std.map[QString, NatronEngine.Natron.Python.NodeCreationProperty]=NodeCreationPropertyMap())->NatronEngine.Natron.Python.Effect",
    "NatronEngine.Natron.Python.App.createReader(self,filename:QString,group:NatronEngine.Natron.Python.Group=0,props:std.map[QString, NatronEngine.Natron.Python.NodeCreationProperty]=NodeCreationPropertyMap())->NatronEngine.Natron.Python.Effect",
    "NatronEngine.Natron.Python.App.createWriter(self,filename:QString,group:NatronEngine.Natron.Python.Group=0,props:std.map[QString, NatronEngine.Natron.Python.NodeCreationProperty]=NodeCreationPropertyMap())->NatronEngine.Natron.Python.Effect",
    "NatronEngine.Natron.Python.App.getAppID(self)->int",
    "NatronEngine.Natron.Python.App.getProjectParam(self,name:QString)->NatronEngine.Natron.Python.Param",
    "NatronEngine.Natron.Python.App.getViewNames(self)->std.list[QString]",
    "NatronEngine.Natron.Python.App.loadProject(self,filename:QString)->NatronEngine.Natron.Python.App",
    "NatronEngine.Natron.Python.App.newProject(self)->NatronEngine.Natron.Python.App",
    "1:NatronEngine.Natron.Python.App.render(self,writeNode:NatronEngine.Natron.Python.Effect,firstFrame:int,lastFrame:int,frameStep:int=1)",
    "0:NatronEngine.Natron.Python.App.render(self,effects:std.list[NatronEngine.Natron.Python.Effect],firstFrames:std.list[int],lastFrames:std.list[int],frameSteps:std.list[int])",
    "NatronEngine.Natron.Python.App.resetProject(self)->bool",
    "NatronEngine.Natron.Python.App.saveProject(self,filename:QString)->bool",
    "NatronEngine.Natron.Python.App.saveProjectAs(self,filename:QString)->bool",
    "NatronEngine.Natron.Python.App.saveTempProject(self,filename:QString)->bool",
    "NatronEngine.Natron.Python.App.timelineGetLeftBound(self)->int",
    "NatronEngine.Natron.Python.App.timelineGetRightBound(self)->int",
    "NatronEngine.Natron.Python.App.timelineGetTime(self)->int",
    "NatronEngine.Natron.Python.App.writeToScriptEditor(self,message:QString)",
    nullptr}; // Sentinel
...
void init_Natron_Python_App(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_App_Type);
    InitSignatureStrings(pyType, Natron_Python_App_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_App_Type), Sbk_Natron_Python_App_PropertyStrings);
