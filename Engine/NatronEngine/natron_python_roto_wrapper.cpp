...
static const char *Sbk_Natron_Python_Roto_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_Roto_SignatureStrings[] = {
    "NatronEngine.Natron.Python.Roto.createBezier(self,x:double,y:double,time:double)->NatronEngine.Natron.Python.BezierCurve",
    "NatronEngine.Natron.Python.Roto.createEllipse(self,x:double,y:double,diameter:double,fromCenter:bool,time:double)->NatronEngine.Natron.Python.BezierCurve",
    "NatronEngine.Natron.Python.Roto.createLayer(self)->NatronEngine.Natron.Python.Layer",
    "NatronEngine.Natron.Python.Roto.createRectangle(self,x:double,y:double,size:double,time:double)->NatronEngine.Natron.Python.BezierCurve",
    "NatronEngine.Natron.Python.Roto.getBaseLayer(self)->NatronEngine.Natron.Python.Layer",
    "NatronEngine.Natron.Python.Roto.getItemByName(self,name:QString)->NatronEngine.Natron.Python.ItemBase",
    nullptr}; // Sentinel
...
void init_Natron_Python_Roto(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Roto_Type);
    InitSignatureStrings(pyType, Natron_Python_Roto_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_Roto_Type), Sbk_Natron_Python_Roto_PropertyStrings);
