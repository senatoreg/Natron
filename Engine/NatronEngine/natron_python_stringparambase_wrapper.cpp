...
static const char *Sbk_Natron_Python_StringParamBase_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_StringParamBase_SignatureStrings[] = {
    "NatronEngine.Natron.Python.StringParamBase.addAsDependencyOf(self,fromExprDimension:int,param:NatronEngine.Natron.Python.Param,thisDimension:int)->QString",
    "1:NatronEngine.Natron.Python.StringParamBase.get(self)->QString",
    "0:NatronEngine.Natron.Python.StringParamBase.get(self,frame:double)->QString",
    "NatronEngine.Natron.Python.StringParamBase.getDefaultValue(self)->QString",
    "NatronEngine.Natron.Python.StringParamBase.getValue(self)->QString",
    "NatronEngine.Natron.Python.StringParamBase.getValueAtTime(self,time:double)->QString",
    "NatronEngine.Natron.Python.StringParamBase.restoreDefaultValue(self)",
    "1:NatronEngine.Natron.Python.StringParamBase.set(self,x:QString)",
    "0:NatronEngine.Natron.Python.StringParamBase.set(self,x:QString,frame:double)",
    "NatronEngine.Natron.Python.StringParamBase.setDefaultValue(self,value:QString)",
    "NatronEngine.Natron.Python.StringParamBase.setValue(self,value:QString)",
    "NatronEngine.Natron.Python.StringParamBase.setValueAtTime(self,value:QString,time:double)",
    nullptr}; // Sentinel
...
void init_Natron_Python_StringParamBase(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_StringParamBase_Type);
    InitSignatureStrings(pyType, Natron_Python_StringParamBase_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_StringParamBase_Type), Sbk_Natron_Python_StringParamBase_PropertyStrings);
