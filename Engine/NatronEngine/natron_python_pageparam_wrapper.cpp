...
static const char *Sbk_Natron_Python_PageParam_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_PageParam_SignatureStrings[] = {
    "NatronEngine.Natron.Python.PageParam.addParam(self,param:NatronEngine.Natron.Python.Param)",
    nullptr}; // Sentinel
...
void init_Natron_Python_PageParam(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_PageParam_Type);
    InitSignatureStrings(pyType, Natron_Python_PageParam_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_PageParam_Type), Sbk_Natron_Python_PageParam_PropertyStrings);
