...
static const char *Sbk_Natron_Python_ExprUtils_PropertyStrings[] = {
    nullptr // Sentinel
};
...
static const char *Natron_Python_ExprUtils_SignatureStrings[] = {
    "NatronEngine.Natron.Python.ExprUtils(self)",
    ...
    "NatronEngine.Natron.Python.ExprUtils.snoise(self,p:NatronEngine.Natron.Python.Double3DTuple)->double",
...
void init_Natron_Python_ExprUtils(PyObject *enclosingClass)
{
    ...
    auto pyType = reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_ExprUtils_Type);
    InitSignatureStrings(pyType, Natron_Python_ExprUtils_SignatureStrings);
    SbkObjectType_SetPropertyStrings(reinterpret_cast<PyTypeObject *>(_Sbk_Natron_Python_ExprUtils_Type), Sbk_Natron_Python_ExprUtils_PropertyStrings);
